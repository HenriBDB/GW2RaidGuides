    ...
    return (
        ...
        <SkillCard skillID={14431}>
            <p>
                ...
                additional Burning <WikiIcon name="Burning"/> and thus also more damage. With Crack Shot there is a potential of 4 Burning <WikiIcon name="Burning"/>
        ...
        <SkillCard skillID={14519}>
            <p>
                ...
                Burning <WikiIcon name="Burning"/> is applied immediately on hit, rather than ticking in over time. 2 of these should be used
                when on Longbow.
            </p>
        </SkillCard>
        ...
        <SkillCard skillID={14505}>
            <p>
                ...
                with a fire field when used like that, making it apply 1 stack of Burning <WikiIcon name="Burning"/> which is alright for a
        ...
        <SkillCard skillID={14504}>
            <p>
                ...
                will also apply 1 stack of Burning <WikiIcon name="Burning"/>. The Bleed <WikiIcon name="Bleeding"/> lasts so long that it actually deals a fair bit of
                damage overall. This skill needs to be used almost as it comes off cooldown if possible.
            </p>
        </SkillCard>
        <SkillCard skillID={29923}>
            <p>
                It applies 3 stacks of Burning <WikiIcon name="Burning"/> over its duration. What really speaks for this skill is its insanely
