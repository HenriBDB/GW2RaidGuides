    ...
    return (
        ...
        <SkillCard skillID={29845}>
            <p>
                ...
                the Burning <WikiIcon name="Burning"/> is solid.
            </p>
        </SkillCard>
        <SkillCard skillID={29940}>
            <p>
                Applies 6 stacks of Burning <WikiIcon name="Burning"/> before detonating for another 2 stacks, which is a huge amount of
