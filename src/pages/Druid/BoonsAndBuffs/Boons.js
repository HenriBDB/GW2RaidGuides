                ...
                <p>
                    ...
                    <ul className="mt-0">
                        <li><span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="31796"></span>, 
                            ...
                            <span><img alt="Might.png" src="https://wiki.guildwars2.com/images/thumb/7/7c/Might.png/20px-Might.png" width="20" height="20"/><sub>2</sub></span>
                            Might (12s).
                        </li>
                        <li><span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="32253"></span> generates 
                            <span><img alt="Might.png" src="https://wiki.guildwars2.com/images/thumb/7/7c/Might.png/20px-Might.png" width="20" height="20"/><sub>10</sub></span>
                            Might (12s).
                        </li>
                        <li><span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="34070"></span> generates 
                            <span><img alt="Might.png" src="https://wiki.guildwars2.com/images/thumb/7/7c/Might.png/20px-Might.png" width="20" height="20"/><sub>8</sub></span>
                            Might (12s).
                        </li>
                    </ul>
                </p>
        ...
        <div className="row">
            ...
            <div className="col-11">
                <p>
                    ...
                    Fury is <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12621"></span> which with the traits 
                    <span data-armory-embed="traits" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="964"></span> and 
                    <span data-armory-embed="traits" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="1064"></span> allow you to upkeep 
                    <span><img alt="Fury.png" src="https://wiki.guildwars2.com/images/thumb/4/46/Fury.png/20px-Fury.png" width="20" height="20"/></span> Fury for your sub-squad. <br/>
                    If you are not running warhorn, then you should take the trait <span data-armory-embed="traits" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="965"></span> 
                    instead of <span data-armory-embed="traits" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="964"></span> which allows 
                    you to generate 80% <span><img alt="Fury.png" src="https://wiki.guildwars2.com/images/thumb/4/46/Fury.png/20px-Fury.png" width="20" height="20"/></span> 
        ...
        <div className="row">
            ...
            <div className="col-11">
                <p>
                    ...
                    has <span><img alt="Regeneration.png" src="https://wiki.guildwars2.com/images/thumb/5/53/Regeneration.png/20px-Regeneration.png" width="20" height="20"/></span> Regeneration, you will recharge 15% 
                    of your Astral Force every second which means it fully recharges in a mere 7 seconds. <br/>
                    If other players also provide <span><img alt="Regeneration.png" src="https://wiki.guildwars2.com/images/thumb/5/53/Regeneration.png/20px-Regeneration.png" width="20" height="20"/></span> Regeneration, 
                    the stacks that provide the highest healing will be consumed first so make sure you upkeep your <span data-armory-embed="traits" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="1992"></span> and 
                    <span data-armory-embed="items" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="24842"></span> stacks so that your <span><img alt="Regeneration.png" src="https://wiki.guildwars2.com/images/thumb/5/53/Regeneration.png/20px-Regeneration.png" width="20" height="20"/></span> Regeneration 
                    is the one ticking on the squad.
                </p>
                <p>Your skills that grant <span><img alt="Regeneration.png" src="https://wiki.guildwars2.com/images/thumb/5/53/Regeneration.png/20px-Regeneration.png" width="20" height="20"/></span> Regeneration:</p>
                <ul>
