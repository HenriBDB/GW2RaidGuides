...
const CommIntro = () => {
    return (
        <SectionContainer>
            <GuideTitle title="Squadmaking Guide" footer="Raid squad compositions by Wasabi" />
            <GuideDescription>
                <p>&emsp;Ever wondered why SC raid comps differ so much from pug groups? Why do we split squad into two (or more) subgroups? What roles do you need to look for when pugging? This guide will teach you what goes into creating a functioning raid squad, with all the nuances and details.</p>
