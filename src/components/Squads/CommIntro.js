    ...
    return (
        <SectionContainer>
            ...
            <GuideDescription>
                ...
                <p style={{fontSize: '1.5rem', textAlign: 'center', fontFamily: "Noto serif"}}>Guide is <span style={{color: 'green', fontFamily: "Noto serif"}}>up to date</span> as of JULY 7th 2020 balance patch. <br /><span style={{color: 'red', fontFamily: "Noto serif"}}>Not up to date</span> as of MAY 25th 2021 balance patch.</p>
            </GuideDescription>
        </SectionContainer>
    )
}
