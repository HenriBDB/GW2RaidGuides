        ...
        <SectionContainer>
            ...
            <NavTabs tabNames={["Utility", "DPS"]} hrefs={["squad-utility", "squad-dps-class"]} gameClass="commander">
                ...
                <TabPane tabName="squad-dps-class" active={false}>
                    ...
                    <p>
                        This might be obvious, but sometimes the right answer is just class with <b>highest damage output</b>. We can see it in current meta, where a lot of records are being broken with <WikiIcon name={"Chronomancer"} /> <b>Power Chronomancers</b>, even bosses community deemed as <b>condi</b>. Why is that?
                    </p>
                    <p>
                        With the exception of <WikiIcon name={"Confusion"} /> <b>Confusion</b> (and <WikiIcon name={"Torment"} /> Torment, to lesser extent), bosses <b>do not</b> take more damage from conditions than usual. It has to do more with <WikiIcon name={"Invuln"} /> <b>invulnerability phases</b> and other elements, like short damage boosts (<WikiIcon name={"UnnaturalSignet"} /> signet on <WikiIcon name={"Deimos"} /> Deimos, <WikiIcon name={"Fractured"} /> swords on <WikiIcon name={"CA"} /> CA). While the damage <b>boosts both</b> types of damage, the short durations (and short phases) tends to favor power damage more, as conditions need a while to ramp up.
                    </p>
                    <p>
                        However, what’s important to note, even the ‘short’ phases - <WikiIcon name={"Slothasor"} /> Slothasor, <WikiIcon name={"Gorseval"} /> Gorseval or <WikiIcon name={"CA"} /> Conjured Amalgamate for example - <b>are long enough for conditions to catch up</b>. In pug groups that is, in organized groups where you know damage output of your teammates, it might not hold true.
                    </p>
                    <p>
