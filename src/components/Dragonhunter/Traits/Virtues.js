...
const Virtues = ({ showGear }) => {
    return (
        <>
            ...
            <p className="dh-trait-intro">
                Given the above, in pugs or less organized groups it will usually be only worth taking with a <WikiIcon name={"Thief"} /> Boonthief present, so on bosses like MO, Adina.
            </p>
