...
const DhRotation = ({ showGuides, showTraits }) => {
    ...
    return (
        <SectionContainer>
            <SectionIntro>
                <p>Dragonhunter rotation revolves around damage modifiers and it is very easy to learn once you know the basics. You can already find written rotation breakdown on Snow Crows website, so here I will be focusing on explaining why DH rotation is built like this in the form of the video.</p>
