...
const Utility = () => {
    return(
        <>
            <p>
                Most of the time, a druid generously provides 3 spirits at the disposition of the squad for ultimate support. You should check&nbsp; 
                <SectionLink sectionId="druid-boons-and-buffs"><strong>Boons and Buffs &#62; Spirits</strong></SectionLink> to know when to take which spirit. 
                The basic setup will be <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12495"></span>, <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12497"></span>, <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12498"></span> but 
                it can change depending on the situation as described in the passage linked above. You will always have at least 2 spirits. In case 
                you have a free utility slot because only 2 spirits are of use on a fight, you can fill the opn slot with one of the following: 
            </p>
            <div class="row mt-3">
