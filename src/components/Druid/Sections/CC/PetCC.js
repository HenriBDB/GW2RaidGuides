...
const PetCC = () => {
    return (
        <>
            <div class="row mt-3">
                <div class="col-lg-12"><WikiIcon name="Gazelle" size={30}/> Rock Gazelle</div>
            ...
            <div class="row mt-3">
                <div class="col-lg-12"><WikiIcon name="ElectricWyvern" size={30}/> Electric Wyvern</div>
            ...
            <div class="row mt-3">
                <div class="col-lg-12"><WikiIcon name="ElectricWyvern" size={30}/> Any Wyvern (AI skill)</div>
            ...
            <div class="row mt-3">
                <div class="col-lg-12"><WikiIcon name="Gazelle" size={30}/> Rock Gazelle (AI skill)</div>
            ...
            <div class="row mt-3">
                <div class="col-lg-12"><WikiIcon name="PinkMoa" size={30}/> Pink Moa</div>
                <div class="col-lg-3" data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12708"></div>
            ...
            <div class="row mt-3">
                <div class="col-lg-12"><WikiIcon name="Smokescale" size={30}/> Smokescale (AI skill)</div>
            ...
            <div class="row mt-3">
                <div class="col-lg-12"><WikiIcon name="Iboga" size={30}/> Iboga</div>
