        ...
        <SectionCollapsible gameClass="ranger" title="Weapon Skills" id="druid-weapon-skills">
            <SectionIntro>
                <p>
                    ...
                    Take the Shortbow instead of your Staff if you can afford to lose the healing form it. For fights where you are responsible for pushing, you can equip a Longbow 
