...
const Spirits = () => {
    return (
        ...
        <dl className="row">
            <dt className="col-lg-2 font-weight-normal">
                <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="21773"></span>
            </dt>
            <dd className="col-lg-10">Heal on striking a foe. Has a 10 seconds internal cooldown. Heals for 863 (0.125).</dd>
        </dl>
        <dl className="row">
            <dt className="col-lg-2 font-weight-normal">
                <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12498"></span>
            </dt>
            <dd className="col-lg-10">Apply <WikiIcon name="Burning"><sub>2</sub></WikiIcon> Burning (2½s) on striking a foe. Has an 8 seconds internal cooldown.</dd>
        </dl>
        <dl className="row">
            <dt className="col-lg-2 font-weight-normal">
                <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12493"></span>
            </dt>
            <dd className="col-lg-10">Apply <WikiIcon name="Vulnerability"><sub>3</sub></WikiIcon> Vulnerability (6s) on striking a foe. Has a 10 seconds internal cooldown.</dd>
        </dl>
        <dl className="row">
            <dt className="col-lg-2 font-weight-normal">
                <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12497"></span>
            </dt>
            <dd className="col-lg-10">Permanent 5% physical damage modifier.</dd>
        </dl>
        <dl className="row">
            <dt className="col-lg-2 font-weight-normal">
                <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12495"></span>
            </dt>
            <dd className="col-lg-10">Gain <WikiIcon name="Protection"/> Protection (3s) on striking a foe. Has a 10 seconds internal cooldown.</dd>
        </dl>
        <dl className="row">
            <dt className="col-lg-2 font-weight-normal">
                <span data-armory-embed="skills" data-armory-size="20" data-armory-inline-text="wiki" data-armory-ids="12569"></span>
            </dt>
            <dd className="col-lg-10">Does not apply a passive buff but instead heals 10 allies for 101 (0.035) every second. Scales with the Druid's healing power.</dd>
        </dl>
        ...
        <dl className="row">
            ...
            <dd className="col-lg-10">
                Heal yourself and your pet immediately for 3,865 (0.35). Then heals 5 allies for 1,940.
                Note the spirit cannot target itself with its healing.
                <br/>
        ...
        <ul>
            <li>On fights that are condition heavy: Slothasor, Matthias, Xera, Dhuum,
            ...
            for extra dps if you have an available utility spot, especially beneficial for condition classes in your squad.</li>
            ...
            ever your squad is lacking fury or missing vulnerability uptime. Fury and vulnerability uptimes will be placed in <span className="font-italic">Extra Resources</span>.
            ...
            It should always be taken except if protection is covered by someone else or if protection is not needed such as on <WikiIcon name="Samarog"/> Samarog. 
            ...
            taken instead on fights that require <WikiIcon name="Immobile"/> Immobilize such as Vale Guardian and Escort.</li>
        </ul>
        </>
    );
}
