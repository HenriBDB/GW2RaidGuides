        ...
        <>
            <GearCard text={[<WikiIcon name="ElectricWyvern" size={40}/>, "ElectricWyvern"]}>
                <p>
                    ...
                    <br/>
                    <WikiIcon name="Launch"/> Launch 232cc available through it's AI skill Wing Buffet.
                </p>
            </GearCard>
            <GearCard text={[<WikiIcon name="Gazelle" size={40}/>, "Gazelle"]}>
                <p>
                    ...
                    <br/>
                    <WikiIcon name="Daze"/> Daze (2s) 200cc available through it's AI skill Charge.
                </p>
            </GearCard>
            <GearCard text={[<WikiIcon name="PinkMoa" size={40}/>, "Pink Moa"]}>
                <p>
                    ...
                    <br/>
                    Pink moa is practically never taken as a cc pet since it's cc is cast slowly (1s cast) and on a longer recharge than that of the Rock Gazelle (30s vs 20s).
                </p>
            </GearCard>
        </>
    )
